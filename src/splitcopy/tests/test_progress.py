...
class Test_Progress:
    ...
    def test_one_sec_timer_stop(self):
        expected = True
        progress = init_progress()
        self.stop_timer = True
        timer = Thread(
            name="testing_one_sec_timer",
            target=progress.one_sec_timer,
    ...
    def test_one_sec_timer_nocurses(self, monkeypatch: MonkeyPatch):
        expected = True
    ...
    def test_one_sec_timer_curses(self, monkeypatch: MonkeyPatch):
        expected = True
    ...
    def test_redraw_screen(self, capsys, monkeypatch: MonkeyPatch):
